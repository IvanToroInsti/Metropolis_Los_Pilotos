...
export default function MobileFrame({ children }: Frame) {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      {/* Cuerpo del teléfono */}
      <div className="relative w-full max-w-[300px] h-[600px] bg-black rounded-[3rem] border-[8px] border-gray-800 shadow-2xl overflow-hidden">
        ...
        <div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-24 h-1 bg-gray-300 rounded-full mb-1"></div>
      </div>
    </div>
  );
}
